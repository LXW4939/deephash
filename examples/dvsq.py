...
import random
from deephash.util import ProgressBar, Dataset, MAPs, MAPs_CQ
...
class DVSQ(object):
    def __init__(self, config, stage):
        ...
        with tf.device(self.device):
            ...
            # ICM算法中的相关参数：
            # 为什么要单独设置ICM相关变量？因为train batchsize和quantization batch size不一致
            # 下标m，代表第m个subcenter
    ...
    def apply_loss_function(self, global_step):
        ...
        self.cq_loss = self.cq_loss_img * self.cq_lambda
